function localview(className){
	var clickEle = $("."+className);
	if(clickEle){
		var attr = clickEle.attr("type-url");
...
function init_wysiwyg() {
    function b(a, b) {
        ...
        $('<div class="alert"> <button type="button" class="close" data-dismiss="alert">×</button><strong>File upload error</strong> ' + c + " </div>").prependTo("#alerts")
    }
